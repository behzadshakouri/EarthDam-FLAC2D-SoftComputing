% ============================================================
% ELMACOR_PT2_FULL70.m
% FULL 70 cases, PT2 style (ELMACOR)
...
% OUTPUT ROOT
outRoot = 'E:\University\My Thesis\Flac model\New\Maku_PT2_Data\ELMACOR_FULL70_OUT';
...
%% ============================================================
% ELM init + ACOR optimize Win & b (NOT outputWeight)
% ============================================================
...
alg = ypea_acor();
alg.max_iter     = acor_max_iter;
alg.pop_size     = acor_pop_size;
alg.sample_count = acor_sample_count;
alg.q            = acor_q;
alg.zeta         = acor_zeta;
alg.display      = false;
...
%% Stats xlsx
stats_xlsx = fullfile(caseDir, sprintf('ELMACOR_%s%s_n%d_Statistics_%s_failmode_%s.xlsx', ...
