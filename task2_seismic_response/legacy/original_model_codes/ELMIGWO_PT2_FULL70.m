% ============================================================
% ELMIGWO_PT2_FULL70.m
% FULL 70 cases, PT2 style (ELMIGWO)
...
%% ============================================================
% ELM init + IGWO optimize Win & b (NOT outputWeight)
% ============================================================
...
objfunc = @(x) rmse_elm_ridge(x(:), inputtrainn_fit, targettrainn_fit, k, hln, activationFunction, lambda_ridge);
[lb, ub] = scalar_bounds_from_x0(x0, bound_scale, bound_cap);

[Fbest, Lbest, Convergence_curve] = IGWO(nnn, N, Max_iteration, lb, ub, objfunc); %#ok<ASGLU>
x = Lbest(:);
...
%% Stats xlsx
stats_xlsx = fullfile(caseDir, sprintf('ELMIGWO_%s%s_n%d_Statistics_%s_failmode_%s.xlsx', ...
