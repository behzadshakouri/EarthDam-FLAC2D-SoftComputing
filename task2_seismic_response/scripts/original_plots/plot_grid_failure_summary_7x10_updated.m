function plot_grid_failure_summary_7x10_updated(FT_file, FULL_file, varargin)
% plot_grid_failure_summary_7x10_updated(FT_file, FULL_file, ...)
% One "all-in-one" heatmap for 70 cases (R rows x P cols).
% Uses FT for failure timing (failed_sim/step_fail/fail_time), FULL for PGA at failure.
%
% ColorBy:
