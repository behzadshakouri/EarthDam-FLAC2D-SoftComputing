...
xdispvalues = {'Q1','Q2','Q3','Q4','Q5','Q6','Q7','Q8','Q9','Q10'};
ydispvalues = {'ELM-IGWO--\delta_y--test','ELM-IGWO--\delta_y--train','ELM-IGWO--\delta_x--test','ELM-IGWO--\delta_x--train', ...
    'ELM-ACOR--\delta_y--test','ELM-ACOR--\delta_y--train','ELM-ACOR--\delta_x--test','ELM-ACOR--\delta_x--train', ...
    'ELM-ABC--\delta_y--test','ELM-ABC--\delta_y--train','ELM-ABC--\delta_x--test','ELM-ABC--\delta_x--train', ...
    'ELM--\delta_y--test','ELM--\delta_y--train','ELM--\delta_x--test','ELM--\delta_x--train'};
ystressvalues = {'ELM-IGWO--\sigma_{yy}--test','ELM-IGWO--\sigma_{yy}--train','ELM-IGWO--\sigma_{xx}--test','ELM-IGWO--\sigma_{xx}--train', ...
    'ELM-ACOR--\sigma_{yy}--test','ELM-ACOR--\sigma_{yy}--train','ELM-ACOR--\sigma_{xx}--test','ELM-ACOR--\sigma_{xx}--train', ...
    'ELM-ABC--\sigma_{yy}--test','ELM-ABC--\sigma_{yy}--train','ELM-ABC--\sigma_{xx}--test','ELM-ABC--\sigma_{xx}--train', ...
    'ELM--\sigma_{yy}--test','ELM--\sigma_{yy}--train','ELM--\sigma_{xx}--test','ELM--\sigma_{xx}--train'};
wposX=100; wposY = 100;
heatmapLength = 1000;
heatmapWidth = 1000;
...
h1=heatmap(xdispvalues,ydispvalues,R2disp);
...
figure('Renderer', 'painters', 'Position', [wposX wposY heatmapWidth heatmapLength]);
h2=heatmap(xdispvalues,ystressvalues,R2stress);
...
figure('Renderer', 'painters', 'Position', [wposX wposY heatmapWidth heatmapLength]);
h3=heatmap(xdispvalues,ydispvalues,a10disp);
...
figure('Renderer', 'painters', 'Position', [wposX wposY heatmapWidth heatmapLength]);
h4=heatmap(xdispvalues,ystressvalues,a10stress);
...
%------------------Error figures------------------------
figure('Renderer', 'painters', 'Position', [wposX wposY heatmapWidth heatmapLength]);
h5=heatmap(xdispvalues,ydispvalues,100*RMSEdisp);
...
figure('Renderer', 'painters', 'Position', [wposX wposY heatmapWidth heatmapLength]);
h6=heatmap(xdispvalues,ystressvalues,0.001*RMSEstress);
...
figure('Renderer', 'painters', 'Position', [wposX wposY heatmapWidth heatmapLength]);
h7=heatmap(xdispvalues,ydispvalues,100*MAEdisp);
...
figure('Renderer', 'painters', 'Position', [wposX wposY heatmapWidth heatmapLength]);
h8=heatmap(xdispvalues,ystressvalues,0.001*MAEstress);
