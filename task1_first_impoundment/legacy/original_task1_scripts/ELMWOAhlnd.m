...
Comment1='ELMWOA_';
Comment2='ELMWOA-Train';
Comment3='ELMWOA-Test';
...
%% Run Hybridization with WOA
SearchAgents_no=30;
Max_iter=1000;

fobj = @(x) RMSE(x, elm, inputtrainn, targettrainn,x1,x2,k,hln);

[Leader_score,Leader_pos,Convergence_curve]=WOA(SearchAgents_no,Max_iter,-1,1,nnn,fobj); %#ok
...
ELMWOA1.Ptest=Ptest;
ELMWOA1.Ptrain=Ptrain;
ELMWOA1.Ttrain=Ttrain;
ELMWOA1.Ttest=Ttest;
...
[Leader_score,Leader_pos,Convergence_curve]=WOA(SearchAgents_no,Max_iter,-1,1,nnn,fobj);
