...
% h=scatter(ntrain,train.R2);
% hold on
% h=scatter(ntest,test.R2);
% hold on
% line(ntrain,train.R2);
% hold on;
% line(ntest,test.R2);
% 
% h.XLabel = 'QoIs';
...
%     h=scatter(ntrain(1,:),ELM.train.R2(j,i));
    %hold on
    %h=scatter(ntest,ELM.test.R2(j,i));
    %hold on
    %line(ntrain,ELM.train.R2(j,i));
    %hold on;
    %line(ntest,ELM.test.R2(j,i));
    %hold on
    
%     end
    
%     if nsample==500
%         hTitle = [a1 ' nsample diagram for ' Res{1,j} ' & nsample' num2str(nsample)];
%         saveas(h,[hTitle '.png']);
%     end
%     hold off
