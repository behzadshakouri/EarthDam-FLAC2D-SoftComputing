...
nsample=[50 100 150 200 300 400 500];
    ...
    for l=1:8
        ...
        p(2).MarkerFaceColor = [0.6 0.8 0.2];
        p(3).MarkerFaceColor = [0.494 0.184 0.556];
        hTitleRMSEtrain = 'Train data RMSE ratio for FoS';
        ...
        p(2).MarkerFaceColor = [0.6 0.8 0.2];
        p(3).MarkerFaceColor = [0.494 0.184 0.556];
        hTitleMAEtrain = 'Train data MAE ratio for FoS';
        xlabel('ntrain','FontSize',14);
        ...
        p(2).MarkerFaceColor = [0.6 0.8 0.2];
        p(3).MarkerFaceColor = [0.494 0.184 0.556];
        hTitlea10train = 'Train data a10-index ratio for FoS';
        xlabel('ntrain','FontSize',14);
        ...
        p(2).MarkerFaceColor = [0.6 0.8 0.2];
        p(3).MarkerFaceColor = [0.494 0.184 0.556];
        hTitleRMSEtest = 'Test data RMSE ratio for FoS';
        xlabel('ntrain','FontSize',14);
        ylabel('RMSE ratio','FontSize',14);
        ...
        p(2).MarkerFaceColor = [0.6 0.8 0.2];
        p(3).MarkerFaceColor = [0.494 0.184 0.556];
        hTitleMAEtest = 'Test data MAE ratio for FoS';
        xlabel('ntrain','FontSize',14);
        ylabel('MAE ratio','FontSize',14);
        ...
        p(2).MarkerFaceColor = [0.6 0.8 0.2];
        p(3).MarkerFaceColor = [0.494 0.184 0.556];
        hTitlea10test = 'Test data a10-index ratio for FoS';
        xlabel('ntrain','FontSize',14);
        ylabel('a10-index ratio','FontSize',14);
