...
if a==1
    ...
    p=plot(FDM_ELM_FoSdata(:,19),FDM_ELM_FoSdata(:,20),'ko','LineWidth',1.25,'MarkerSize',6);
...
elseif a==2
    ...
    fig=figure('DefaultAxesFontSize',12);
    p=plot(FDM_ELMABC_FoSdata(:,19),FDM_ELMABC_FoSdata(:,20),'ko','LineWidth',1.25,'MarkerSize',6);
    p(1).MarkerFaceColor = [0.850 0.325 0.098];
...
elseif a==3
    ...
    fig=figure('DefaultAxesFontSize',12);
    p=plot(FDM_ELMACOR_FoSdata(:,19),FDM_ELMACOR_FoSdata(:,20),'ko','LineWidth',1.25,'MarkerSize',6);
    p(1).MarkerFaceColor = [0.850 0.325 0.098];
...
elseif a==4
    ...
    fig=figure('DefaultAxesFontSize',12);
    p=plot(FDM_ELMIGWO_FoSdata(:,19),FDM_ELMIGWO_FoSdata(:,20),'ko','LineWidth',1.25,'MarkerSize',6);
    p(1).MarkerFaceColor = [0.850 0.325 0.098];
